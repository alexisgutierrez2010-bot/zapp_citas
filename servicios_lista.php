...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="servicios_crear.php" method="POST">
                            <div class="mb-3"><label for="nombre_servicio" class="form-label">Nombre del Servicio</label>
                                <input type="text" class="form-control" id="nombre_servicio" name="nombre_servicio" required>
                            </div>
                            <div class="mb-3"><label class="form-label">Duración</label>
                            ...
                            <div class="mb-3"><label for="precio" class="form-label">Precio (opcional)</label>
            ...
            <div class="col-md-8"><h3>Lista de Servicios</h3>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT id_servicio, nombre_servicio, duracion_valor, duracion_unidad, precio, activo, fecha_registro FROM j104_servicios WHERE id_negocio = ? ORDER BY activo DESC, nombre_servicio ASC";
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td>
                                            ...
                                            <form action="servicios_eliminar.php" method="POST" style="display:inline-block;" onsubmit="return confirm(\'¿Estás seguro de que quieres desactivar este servicio?\');">
