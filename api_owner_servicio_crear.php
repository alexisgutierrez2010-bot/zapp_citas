...
if ($stmt->execute()) {
    ...
    registrar_auditoria($conn, $_SESSION['owner_id_usuario'], $id_negocio_session, 'OWNER_SPA_SERVICE_CREATE', "Propietario creó nuevo servicio '{$nombre_servicio}' (ID: {$id_nuevo_servicio}).");
