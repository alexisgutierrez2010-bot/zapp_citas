...
if (isset($_SESSION['client_last_activity']) && (time() - $_SESSION['client_last_activity'] > SESSION_TIMEOUT)) {
    ...
    registrar_auditoria($conn, $_SESSION['client_id_usuario'], $_SESSION['client_id_negocio'], 'SESSION_TIMEOUT', "La sesión del cliente '{$_SESSION['client_nombre_completo']}' en la SPA expiró por inactividad.");
