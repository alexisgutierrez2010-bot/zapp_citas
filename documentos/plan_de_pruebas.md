...
| # | Caso de Prueba | Pasos a Seguir | Resultado Esperado | Estado |
|:-:|:---|:---|:---|:---:|
| 2.1 | **Auto-Registro de Propietario** | 1. Ir a `spa_owner.php`.<br>2. Intentar login con un número de teléfono nuevo.<br>3. Seguir el flujo "Sí, Registrar Negocio".<br>4. Llenar el formulario de registro completo.<br>5. Enviar. | 1. Se muestra la pantalla de confirmación.<br>2. El formulario de registro se muestra correctamente.<br>3. El negocio se crea con `activo = 4` (Pendiente).<br>4. Se reciben los correos de notificación. | ☐ |
| 2.2 | **Login de Propietario** | 1. Intentar login con el negocio recién creado (estado Pendiente).<br>2. Usar el Panel de Admin para aprobar el negocio (cambiar `activo` a `1`).<br>3. Volver a intentar el login. | 1. El login falla con mensaje de "Pendiente de aprobación".<br>2. El login es exitoso.<br>3. La imagen de fondo personalizada se carga correctamente. | ☐ |
...
| # | Caso de Prueba | Pasos a Seguir | Resultado Esperado | Estado |
|:-:|:---|:---:|:---|:---:|
| 3.1 | **Auto-Registro de Cliente** | 1. Ir a `spa_client.php`.<br>2. Intentar login con un número de teléfono nuevo.<br>3. Seguir el flujo "Sí, registrarme".<br>4. Llenar el formulario de registro, seleccionando el negocio creado en las fases anteriores.<br>5. Enviar. | 1. Se muestra la pantalla de confirmación.<br>2. El formulario de registro se muestra correctamente.<br>3. El cliente se crea en la BD.<br>4. Se recibe el correo de bienvenida. | ☐ |
| 3.2 | **Login de Cliente** | 1. Iniciar sesión con el número de teléfono del cliente recién creado. | 1. El login es exitoso.<br>2. El dashboard del cliente se muestra correctamente, indicando que no hay citas. | ☐ |
