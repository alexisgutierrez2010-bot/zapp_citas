...
if (isset($_SESSION['owner_loggedin']) && $_SESSION['owner_loggedin'] === true) {
    registrar_auditoria($conn, $_SESSION['owner_id_usuario'], $_SESSION['owner_id_negocio'], 'OWNER_SPA_LOGOUT', "Propietario '{$_SESSION['owner_nombre_usuario']}' cerró sesión en la SPA.");
}
