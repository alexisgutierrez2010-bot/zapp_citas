...
if ($stmt->execute()) {
    registrar_auditoria($conn, $_SESSION['owner_id_usuario'], $id_negocio_session, 'OWNER_SPA_SERVICE_UPDATE', "Propietario actualizó servicio '{$nombre_servicio}' (ID: {$id_servicio}).");
