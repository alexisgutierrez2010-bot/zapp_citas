...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header"><h3>Editando País: <?php echo htmlspecialchars($pais['nombre_pais']); ?></h3></div>
                    <div class="card-body">
                        <form action="paises_actualizar.php" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="codigo_pais" class="form-label">Código (2 letras)</label>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-success">Actualizar País</button>
                                <a href="paises_lista.php" class="btn btn-secondary">Cancelar</a>
                            </div>
                        </form>
                    </div>
                </div>
